...
freq, lemma, stop = read_doc("../pros_from_collection")
replace_with_lemma("../pros_from_collection", "pro", freq, lemma, stop)
freq, lemma, stop = read_doc("../cons_from_collection")
replace_with_lemma("../cons_from_collection", "con", freq, lemma, stop)
freq, lemma, stop = read_doc("../all_from_collection")
replace_with_lemma("../all_from_collection", "all", freq, lemma, stop)